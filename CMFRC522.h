...
public:
	...
	CMFRC522(uint8_t chipSelectPin, uint8_t resetPowerDownPin);
...
protected:
	uint8_t _chipSelectPin;		// Arduino pin connected to CMFRC522's SPI slave select input (Pin 24, NSS, active low)
